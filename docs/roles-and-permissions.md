...
- Start with a narrow MVP and one pilot geography before expanding. center capability model.

4. Application case workflow.
5. Document upload pipeline.
6. Chat system.
7. Partial/final payment flow.
8. Admin tools.
9. AI assistant integration.

## Output expectations

When asked to generate plans, agents should usually return:
...
- API outline,
- state machine,
- implementation milestones.et of common, high-friction service categories and a limited geography for pilot validatio
...
- Manage services and operators
- View all requests
- Configure staged payments
- Access audit logs
